...
Mijie（谜界）是一个专为解谜游戏设计的网络平台，支持高度自由的题目形式，内置流程图、排行榜、公告、提交记录等丰富功能，帮助解谜爱好者快速搭建属于自己的在线解谜游戏。

> 本项目最初是为 2023 年北京邮电大学百团大战中举办的解谜游戏「哈士奇再现」开发。之后的 2024 年百团大战解谜游戏「哈士奇的复仇」、哈士奇壬寅年解谜游戏和癸卯年解谜游戏也使用了 Mijie。
